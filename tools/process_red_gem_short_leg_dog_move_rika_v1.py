...
ANIMATION_ROOT = ROOT / "output/sprite_animation_candidates/red_gem_short_leg_dog"
...
MAGENTA_SHEET_PATH = VERSION_ROOT / "source/red_gem_short_leg_dog_move_sheet_chroma_v1.png"
SKILL_OUTPUT_DIR = VERSION_ROOT / "processor_qc"
FRAME_DIR = VERSION_ROOT / "frames"
SHEET_PATH = ANIMATION_ROOT / "red_gem_short_leg_dog_move_sheet_v1.png"
OVERVIEW_PATH = VERSION_ROOT / "red_gem_short_leg_dog_move_overview_v1.png"
ZOOM_OVERVIEW_PATH = ROOT / "output/red_gem_short_leg_dog_move_frames_4x_v1.png"
GIF_PATH = ROOT / "output/red_gem_short_leg_dog_move_preview_v1.gif"
SLOW_GIF_PATH = ROOT / "output/red_gem_short_leg_dog_move_preview_slow_v1.gif"
SUBMISSION_PATH = ROOT / "output/sprite_animation_candidates/_manifests/red_gem_short_leg_dog/move_v1/submission.json"
QA_REPORT_PATH = ROOT / "output/sprite_animation_candidates/_manifests/red_gem_short_leg_dog/move_v1/qa_report.json"
...
def main() -> None:
    ...
    report = {
        ...
        "visual_qa_notes": [
            "All 16 frames preserve the same left-facing short-legged dog identity, gray-white and cyan palette, red forehead gem, short whiskers, hard pixel outline, face, ears, chest fur and enormous curled tail.",
