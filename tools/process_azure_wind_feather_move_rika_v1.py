...
MAGENTA_SHEET_PATH = VERSION_ROOT / "source/azure_wind_feather_move_sheet_chroma_v1.png"
SKILL_OUTPUT_DIR = VERSION_ROOT / "processor_qc"
FRAME_DIR = VERSION_ROOT / "frames"
SHEET_PATH = ANIMATION_ROOT / "azure_wind_feather_move_sheet_v1.png"
OVERVIEW_PATH = VERSION_ROOT / "azure_wind_feather_move_overview_v1.png"
ZOOM_OVERVIEW_PATH = ROOT / "output/azure_wind_feather_move_frames_4x_v1.png"
GIF_PATH = ROOT / "output/azure_wind_feather_move_preview_v1.gif"
...
def main() -> None:
    ...
    if any(box is None for box in alpha_boxes):
        raise ValueError("At least one extracted frame is empty")
    boxes = [box for box in alpha_boxes if box is not None]
    ...
    report = {
        ...
        "alpha_bounding_boxes": [list(box) for box in boxes],
