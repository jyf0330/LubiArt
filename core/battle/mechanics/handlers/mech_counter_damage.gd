...
func after_hit(port: RefCounted, target: Dictionary, source: Dictionary, _amount: int, _damage_props: Dictionary, mechanism: Dictionary) -> Array:
	return _reflect(port, target, source, int(port.mechanic_param_int(target, mechanism, "reflect", 2)), mechanism)


func _reflect(port: RefCounted, target: Dictionary, source: Dictionary, reflect: int, mechanism: Dictionary) -> Array:
