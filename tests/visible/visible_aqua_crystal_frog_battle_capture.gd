...
const SOURCE_PATH := "res://art/images/shared/pets/sheets/slices/pet_style_901_aqua_crystal_frog.png"
const OUTPUT_DIR := "res://output/qa/aqua_crystal_frog/battle_runtime"
...
func _run() -> void:
	...
	print("VISIBLE_AQUA_CRYSTAL_FROG_BATTLE_PASS output=%s" % OUTPUT_DIR)
	quit(0)
...
func _snapshot() -> Dictionary:
	var units := [
		{
			"id": "aqua_crystal_frog",
			"image_path": SOURCE_PATH,
			"name": "Aqua Crystal Frog",
			"side": "player",
			"hp": 10,
			"max_hp": 10,
			"shield": 0,
	...
	return {
		"phase": "battle",
		"stateVersion": 1,
		"stateHash": "aqua-crystal-frog-battle-visible",
		"battle_round": 1,
...
func _fail(message: String) -> void:
	push_error("VISIBLE_AQUA_CRYSTAL_FROG_BATTLE_FAIL: %s" % message)
	quit(1)
