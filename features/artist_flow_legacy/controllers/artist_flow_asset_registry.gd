...
const PetAssetResolverScript := preload("res://shared/prefabs/pet/pet_asset_resolver.gd")

const ROUTE_IMAGE_BY_KIND := {
	"shop": "res://assets/artist_ui/debug_images/three_shang.png",
	"reward": "res://assets/artist_ui/debug_images/three_qi.png",
	"battle": "res://assets/artist_ui/debug_images/three_fight_logo.png",
}
const PET_IMAGE_MAP_PATH := "res://assets/artist_ui/pet_sheet/pet_id_map.json"
const PET_SHEET_SLICE_DIR := "res://assets/artist_ui/pet_sheet/slices"
const PET_EXPLICIT_IMAGE_DIR := "res://assets/artist_ui/sprite_images"
const SHOP_CHARACTER_MAP_PATH := "res://assets/artist_ui/shop_characters/shop_character_map.json"
const REWARD_NODE_MAP_PATH := "res://assets/artist_ui/reward_nodes/reward_node_map.json"
...
func route_texture(option: Dictionary, kind: String) -> Texture2D:
	...
	if kind == "reward":
		...
		if reward_node != null:
			return reward_node
	var path := String(ROUTE_IMAGE_BY_KIND.get(kind, "res://assets/artist_ui/debug_images/three_qi_logo.png"))
