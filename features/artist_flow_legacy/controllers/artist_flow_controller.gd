...
const SessionBridgeScript := preload("res://features/artist_flow_legacy/controllers/artist_flow_session_bridge.gd")
const StagePresenterScript := preload("res://features/artist_flow_legacy/presenters/artist_flow_stage_presenter.gd")
const AssetRegistryScript := preload("res://features/artist_flow_legacy/controllers/artist_flow_asset_registry.gd")
const BATTLE_UI_SCENE := preload("res://features/battle/views/battle_view.tscn")
const PET_DETAIL_PANEL_SCENE := preload("res://shared/prefabs/pet/pet_detail_panel.tscn")
const BAZAAR_INFO_PANEL_SCENE := preload("res://features/shop/prefabs/bazaar_info_panel.tscn")
const RoutePresenterScript := preload("res://features/route/presenters/route_presenter.gd")
const ShopPresenterScript := preload("res://features/shop/presenters/shop_presenter.gd")
const InventoryPresenterScript := preload("res://features/inventory/presenters/inventory_presenter.gd")
const PartyPresenterScript := preload("res://features/party/presenters/party_presenter.gd")
const SettlementPresenterScript := preload("res://features/settlement/presenters/settlement_presenter.gd")
