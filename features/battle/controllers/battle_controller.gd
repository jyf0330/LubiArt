...
const BattleAssetRegistryScript := preload("res://features/battle/controllers/battle_asset_registry.gd")
const BattleBoardDimensionsScript := preload("res://core/battle/board_dimensions.gd")
const BattleBoardControllerScript := preload("res://features/battle/controllers/battle_board_controller.gd")
const BattleHudControllerScript := preload("res://features/battle/controllers/battle_hud_controller.gd")
const BattleDetailControllerScript := preload("res://features/battle/controllers/battle_detail_controller.gd")
const BattleCommandBuilderScript := preload("res://features/battle/controllers/battle_command_builder.gd")
const BattleTraceProjectionScript := preload("res://features/battle/controllers/battle_trace_projection.gd")
const GameLogScript := preload("res://core/logging/game_log.gd")
const BattleCellScene := preload("res://features/battle/prefabs/board/battle_cell.tscn")
const BattleUnitScene := preload("res://shared/prefabs/pet/pet_visual.tscn")
const BattleActionPanelScene := preload("res://features/battle/prefabs/hud/battle_action_panel.tscn")
const PetDetailPanelScene := preload("res://shared/prefabs/pet/pet_detail_panel.tscn")
