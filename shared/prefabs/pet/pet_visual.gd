...
const AUTHORED_CREATURE_TEXTURE := preload("res://assets/artist_ui/battle_pet_complete_v2/creature_art.png")
const ATTACK_RANGE_TEXTURE := preload("res://assets/artist_ui/battle_pet_complete_v2/attack_range_cell.png")
