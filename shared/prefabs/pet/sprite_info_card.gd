extends "res://shared/prefabs/pet/sprite_info_panel_component.gd"

const SpriteInfoDataScript := preload("res://shared/prefabs/pet/sprite_info_data.gd")
const SpriteRankStatsScript := preload("res://shared/prefabs/pet/sprite_rank_stats.gd")
