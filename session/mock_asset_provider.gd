...
const PLAYER_FRAME := preload("res://assets/battle_ui/prefabs/select_frames/selection-blue-64.png")
const ENEMY_FRAME := preload("res://assets/battle_ui/prefabs/select_frames/selection-red-64.png")
const PET_TEXTURES := {
