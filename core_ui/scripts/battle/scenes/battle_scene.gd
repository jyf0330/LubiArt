...
@onready var enemy_info_debug_button: Button = $EnemyInfoDebugButton
@onready var enemy_info_debug_overlay: Control = $EnemyInfoDebugOverlay
...
func _ready() -> void:
	...
	enemy_info_debug_button.pressed.connect(_on_enemy_info_debug_button_pressed)
	_update_enemy_info_debug_button_label()
...
func _on_enemy_info_debug_button_pressed() -> void:
	enemy_info_debug_overlay.visible = not enemy_info_debug_overlay.visible
	_update_enemy_info_debug_button_label()


func _update_enemy_info_debug_button_label() -> void:
	enemy_info_debug_button.text = (
		"关闭敌人信息调试"
		if enemy_info_debug_overlay.visible
		else "打开敌人信息调试"
	)
